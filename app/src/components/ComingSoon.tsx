  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <motion.div
        ...
        className="max-w-2xl w-full glass p-12 rounded-3xl text-center"
      >
        {/* Icon */}
        <motion.div
          initial={{ scale: 0 }}
        ...
        {/* Description */}
        <p className="text-lg text-[#9AA4B2] mb-8 leading-relaxed">
          {description}
        </p>
        ...
        <p className="mt-8 text-sm text-[#9AA4B2]">
          ...
          <a href="https://twitter.com/clawdotclick" target="_blank" rel="noopener noreferrer" className="text-[#E8523D] hover:underline">
            Twitter
          </a>
          {' '}for updates.
        </p>
