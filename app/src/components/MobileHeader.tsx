          ...
          <nav className="flex items-center gap-6">
            {menuItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-lg text-[var(--text-secondary)] hover:text-[var(--mint-dark)] transition-colors handwriting"
              >
                {item.label}
              </Link>
            ))}
              ...
              <nav className="py-4 space-y-4">
                {menuItems.map((item) => (
                  <Link
                    ...
                    className="block px-4 py-2 text-lg text-[var(--text-secondary)] hover:text-[var(--mint-dark)] transition-colors handwriting"
                  >
                    {item.label}
                  </Link>
                ))}
