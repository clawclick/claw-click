            ...
            <div className="p-6 space-y-4">
              <div className="bg-[#141414] rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-[#9AA4B2]">Hookless Uniswap V4 Pool</span>
                </div>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-4 rounded-xl text-base font-bold bg-gradient-to-r from-[#E8523D] to-[#FF8C4A] text-white hover:opacity-90 transition-opacity shadow-lg shadow-[#E8523D]/20"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-semibold bg-[#252525] border border-[#333] text-[#9AA4B2] hover:text-white hover:border-[#E8523D]/30 transition-all"
              >
