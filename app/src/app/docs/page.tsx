        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-2 text-sm font-mono">
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                ...
                <span className="text-[#E8523D]">0x18b89e491d8f12d2be6D2A8e945dF4D93F1247a7</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Hook:</span>
                <span className="text-[#FF8C4A]">0x8265be7eb9D7e40c1FAb6CBd8DBc626b31A0aac8</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Factory:</span>
                <span className="text-yellow-400">0xF5979D0fEEd05CEcb94cf62B76FE7E9aB40c6b4a</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Bootstrap ETH:</span>
                <span className="text-green-400">0xE2649737D3005c511a27DF6388871a12bE0a2d30</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Birth Certificate:</span>
                <span className="text-blue-400">0x6E9B093FdD12eC34ce358bd70CF59EeCb5D1A95B</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Memory Storage:</span>
                <span className="text-purple-400">0x81ae37d31C488094bf292ebEb15C6eCfcD9Fad7D</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Launch Bundler:</span>
                <span className="text-pink-400">0x1AF3b3Cd703Ff59D18A295f669Ad9B7051707268</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm font-mono">
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Config:</span>
                <span className="text-[#E8523D]">0xD1D3059569548cB51FF26Eb65Eb45dd13AD2Bf50</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Hook:</span>
                <span className="text-[#FF8C4A]">0x64f7cC79F599efBc8e95978520c5092Ef8DE2AC8</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Factory:</span>
                <span className="text-yellow-400">0xcBcbCC12664F3eE4D20b3F49554BBE55fD7d9746</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Bootstrap ETH:</span>
                <span className="text-green-400">0xe3893b4c3a210571d04561714eFDAd34F80Bc232</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Birth Certificate:</span>
                <span className="text-blue-400">0x4003CbFD62B0b4BAbBdad714e472fCb8D1f03132</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Memory Storage:</span>
                <span className="text-purple-400">0x833FF145e104198793e62593a1dfD4633066B416</span>
              </div>
              <div className="flex justify-between bg-white/5 p-3 rounded border border-white/10">
                <span className="text-white/60">Launch Bundler:</span>
                <span className="text-pink-400">0x8112c14406C0f38C56f13A709498ddEd446a5b7b</span>
              </div>
            </div>
          </div>
        </div>
