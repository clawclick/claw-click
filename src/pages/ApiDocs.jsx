      ...
      <aside className={`api-docs-sidebar ${sidebarOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-content">
          ...
          <div className="sidebar-socials">
            <a href="https://t.me/claw_click" target="_blank" rel="noopener noreferrer" className="sidebar-social-link" title="Telegram">
            ...
            <a href="https://x.com/claw_click_" target="_blank" rel="noopener noreferrer" className="sidebar-social-link" title="X (Twitter)">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
