...
const featureData = {
  ...
  'agent-first-design': {
    ...
    gradient: 'linear-gradient(135deg, #0b8a78 0%, #0a7868 100%)',
  ...
  'multi-chain-routing': {
    ...
    gradient: 'linear-gradient(135deg, #5cd4be 0%, #0d9e8a 100%)',
  ...
  'real-time-market-data': {
    ...
    gradient: 'linear-gradient(135deg, #0a7868 0%, #0b8a78 100%)',
  ...
  'risk-intelligence': {
    ...
    gradient: 'linear-gradient(135deg, #077363 0%, #0a7868 100%)',
