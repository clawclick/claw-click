    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-socials">
          <a href="https://x.com/claw_click_" target="_blank" rel="noopener noreferrer" aria-label="X">
          ...
          <a href="https://t.me/claw_click" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
