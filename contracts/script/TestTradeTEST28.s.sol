...
contract TestTradeTEST28 is Script {
    ...
    address constant TOKEN = 0xeBD74Cc601b0b94D2f5E6E19877a8ccf0a487320; // TEST28
    ...
    function run() external {
        ...
        console.log("Testing trades on TEST28 token...");
        ...
        console.log("");
        console.log("=== TEST28 TRADING COMPLETE ===");
    }
}
