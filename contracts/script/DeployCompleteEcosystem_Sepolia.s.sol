...
/**
 * @title DeployCompleteEcosystem_Sepolia
 * @notice Deploy ALL 7 contracts to Sepolia testnet
 */
contract DeployCompleteEcosystem_Sepolia is Script {
    // Uniswap V4 on Sepolia
    address constant POOL_MANAGER     = 0xE03A1074c86CFeDd5C142C4F04F1a1536e203543;
    address constant POSITION_MANAGER = 0x429ba70129df741B2Ca2a85BC3A2a3328e5c09b4;

    // Treasury
    address constant TREASURY = 0x3472a51BAf1814B59bf7ac55C8CBA679189Bf0e7; // Use deployer as treasury for testnet
    ...
    function run() external {
        ...
        console2.log("============================================");
        console2.log("  COMPLETE ECOSYSTEM DEPLOY - SEPOLIA");
        console2.log("============================================");
